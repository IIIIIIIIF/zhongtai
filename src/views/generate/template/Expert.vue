<template>
  <div class="generateExpert">
    <Upload title="替换专家报告模板" filename="expert.docx"/>
...
<script>
  ...
  import {generateExpert} from "../../../api/local";
      ...
      handleSubmit(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            generateExpert({...forms, names: forms.name, na: forms.name}).then(res => {
